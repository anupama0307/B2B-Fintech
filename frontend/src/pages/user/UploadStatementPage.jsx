          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 mb-6">
              <div className="text-center">
                ...
                <p className="text-gray-500 mb-6">
                  Upload a CSV file to analyze your spending patterns and verify
                  expenses
                </p>
            ...
            <div className="bg-blue-50 rounded-xl p-6 mb-6">
              ...
              <p className="text-sm text-blue-700 mb-3">
                Your CSV should have columns: Date, Description, Debit, Credit,
                Balance
              </p>
            ...
            {result && (
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-red-600">
                      ₹
                      {result.monthly_expenses_from_statement?.toLocaleString(
                        "en-IN"
                      )}
                    </p>
                  </div>
                ...
                {result.expense_mismatch && (
                  <div className="p-4 bg-red-50 border border-red-200 rounded-lg mb-6">
                    ...
                    <p className="text-sm text-red-600">
                      Your stated expenses don't match your bank statement. This
                ...
                {result.spending_breakdown &&
                  result.spending_breakdown.length > 0 && (
                    <div>
