        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to={user?.role === 'admin' ? '/admin' : '/dashboard'} className="flex items-center space-x-2">
              ...
              <div className="flex flex-col">
                ...
                {user?.role !== 'admin' && (
                  <span className="text-xs text-purple-500 dark:text-purple-400 font-medium -mt-1">+ VisualPe</span>
                )}
              </div>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="flex items-center space-x-1 px-4 py-2 text-gray-600 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition"
            >
